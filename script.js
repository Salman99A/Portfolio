...
${this.wrapWithColor(
  "   Exploring new technologies and transforming creative ideas into",
  "#ffffff",
)}
${this.wrapWithColor(
  "   innovative digital experiences and real-world solutions",
  "#ffffff",
)}
...
${this.wrapWithColor("2023 – Present | Navi Mumbai, India", "#ffffff")}

• ${this.wrapWithColor("Web Applications", "#ffa07a")} - ${this.wrapWithColor(
...
${this.wrapWithColor("2024 – Present | Kharghar, Navi Mumbai", "#ffffff")}
...
• ${this.wrapWithColor("Technical Focus", "#ffa07a")} - ${this.wrapWithColor(
      "Exploring cybersecurity, intelligent systems, and modern computing",
      "#ffffff",
    )}
• ${this.wrapWithColor("Applied Learning", "#ffa07a")} - ${this.wrapWithColor(
      "Building real-world projects alongside academic learning",
      "#ffffff",
    )}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:bvdudet.salman123@gmail.com" style="color: #ffffff; text-decoration: none;">bvdudet.salman123@gmail.com</a>',
      "#ffffff",
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/Salman99A" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/Salman99A</a>',
      "#ffffff",
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/s4lman-exe/" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/s4lman-exe/</a>',
      "#ffffff",
    )}

${this.wrapWithColor("╭────────────────────────────────────────────╮", "#ff8c00")}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Feel free to reach out for collabrations!",
      "#ffffff",
    )} ${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor("╰────────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  async showWeather(location, outputElement) {
    ...
    try {
      ...
      // Print simple terminal lines
      this.printToOutput(outputElement, `Weather for ${location}`, "");
      this.printToOutput(outputElement, `Temperature: ${temperature}°C`, "");
      this.printToOutput(outputElement, `Feels like: ${temperature}°C`, "");
      this.printToOutput(outputElement, `Humidity: --`, "");
      this.printToOutput(outputElement, `Wind: ${wind} km/h`, "");
    } catch (error) {
      this.printToOutput(
        outputElement,
  ...
  calculate(expression, outputElement) {
    ...
    try {
      ...
      this.printToOutput(outputElement, `🧮 ${expression}`, "");
      this.printToOutput(outputElement, `= ${formattedResult}`, "");
    } catch (error) {
      this.printToOutput(
        outputElement,
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "salman@ansari: ~/resume";
